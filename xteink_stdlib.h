...
static const uint64_t __attribute((aligned(64))) js_stdlib_table[] = {
  ...
  0x0000000064616f6c,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "Display" (offset=548) */
  0x0079616c70736944,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "width" (offset=550) */
  0x0000006874646977,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "height" (offset=552) */
  0x0000746867696568,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "clear" (offset=554) */
  0x0000007261656c63,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "setColor" (offset=556) */
  0x726f6c6f43746573,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "drawText" (offset=559) */
  0x7478655477617264,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "drawRect" (offset=562) */
  0x7463655277617264,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "fillRect" (offset=565) */
  0x746365526c6c6966,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "drawLine" (offset=568) */
  0x656e694c77617264,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "drawBitmap" (offset=571) */
  0x6d74694277617264,
  0x0000000000007061,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "refresh" (offset=574) */
  0x0068736572666572,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (14 << (JS_MTAG_BITS + 3)), /* "partialRefresh" (offset=576) */
  0x526c616974726170,
  0x0000687365726665,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "Input" (offset=579) */
  0x0000007475706e49,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "KEY_UP" (offset=581) */
  0x000050555f59454b,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "KEY_DOWN" (offset=583) */
  0x4e574f445f59454b,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (8 << (JS_MTAG_BITS + 3)), /* "KEY_BACK" (offset=586) */
  0x4b4341425f59454b,
  0x0000000000000000,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "KEY_OK" (offset=589) */
  0x00004b4f5f59454b,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "KEY_POWER" (offset=591) */
  0x45574f505f59454b,
  0x0000000000000052,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "waitKey" (offset=594) */
  0x0079654b74696177,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "isPressed" (offset=596) */
  0x6573736572507369,
  0x0000000000000064,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (2 << (JS_MTAG_BITS + 3)), /* "FS" (offset=599) */
  0x0000000000005346,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "open" (offset=601) */
  0x000000006e65706f,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "close" (offset=603) */
  0x00000065736f6c63,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "read" (offset=605) */
  0x0000000064616572,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "readChunk" (offset=607) */
  0x6e75684364616572,
  0x000000000000006b,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "write" (offset=610) */
  0x0000006574697277,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "seek" (offset=612) */
  0x000000006b656573,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "size" (offset=614) */
  0x00000000657a6973,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "exists" (offset=616) */
  0x0000737473697865,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "list" (offset=618) */
  0x000000007473696c,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "remove" (offset=620) */
  0x000065766f6d6572,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "mkdir" (offset=622) */
  0x0000007269646b6d,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "System" (offset=624) */
  0x00006d6574737953,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "version" (offset=626) */
  0x006e6f6973726576,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "v1.0.0" (offset=628) */
  0x0000302e302e3176,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "millis" (offset=630) */
  0x000073696c6c696d,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (5 << (JS_MTAG_BITS + 3)), /* "sleep" (offset=632) */
  0x0000007065656c73,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "battery" (offset=634) */
  0x0079726574746162,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (6 << (JS_MTAG_BITS + 3)), /* "reboot" (offset=636) */
  0x0000746f6f626572,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "WiFi" (offset=638) */
  0x0000000069466957,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (7 << (JS_MTAG_BITS + 3)), /* "connect" (offset=640) */
  0x007463656e6e6f63,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (10 << (JS_MTAG_BITS + 3)), /* "disconnect" (offset=642) */
  0x656e6e6f63736964,
  0x0000000000007463,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (11 << (JS_MTAG_BITS + 3)), /* "isConnected" (offset=645) */
  0x63656e6e6f437369,
  0x0000000000646574,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (9 << (JS_MTAG_BITS + 3)), /* "ipAddress" (offset=648) */
  0x7365726464417069,
  0x0000000000000073,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "HTTP" (offset=651) */
  0x0000000050545448,
  (JS_MTAG_STRING << 1) | (1 << JS_MTAG_BITS) | (1 << (JS_MTAG_BITS + 1)) | (0 << (JS_MTAG_BITS + 2)) | (4 << (JS_MTAG_BITS + 3)), /* "post" (offset=653) */
  0x0000000074736f70,

  /* sorted atom table (offset=655) */
  ...
  JS_ROM_VALUE(651), /* HTTP */
  JS_ROM_VALUE(144), /* Infinity */
  JS_ROM_VALUE(579), /* Input */
  ...
  JS_ROM_VALUE(586), /* KEY_BACK */
  JS_ROM_VALUE(583), /* KEY_DOWN */
  JS_ROM_VALUE(589), /* KEY_OK */
  JS_ROM_VALUE(591), /* KEY_POWER */
  JS_ROM_VALUE(581), /* KEY_UP */
  ...
  JS_ROM_VALUE(642), /* disconnect */
  JS_ROM_VALUE(29), /* do */
  JS_ROM_VALUE(571), /* drawBitmap */
  JS_ROM_VALUE(568), /* drawLine */
  JS_ROM_VALUE(562), /* drawRect */
  JS_ROM_VALUE(559), /* drawText */
  JS_ROM_VALUE(8), /* else */
  JS_ROM_VALUE(66), /* enum */
  JS_ROM_VALUE(119), /* eval */
  JS_ROM_VALUE(319), /* every */
  JS_ROM_VALUE(436), /* exec */
  JS_ROM_VALUE(616), /* exists */
  JS_ROM_VALUE(384), /* exp */
  JS_ROM_VALUE(68), /* export */
  JS_ROM_VALUE(70), /* extends */
  JS_ROM_VALUE(2), /* false */
  JS_ROM_VALUE(565), /* fillRect */
  ...
  JS_ROM_VALUE(648), /* ipAddress */
  JS_ROM_VALUE(303), /* isArray */
  JS_ROM_VALUE(645), /* isConnected */
  JS_ROM_VALUE(531), /* isFinite */
  JS_ROM_VALUE(529), /* isNaN */
  JS_ROM_VALUE(596), /* isPressed */
  ...
  JS_ROM_VALUE(630), /* millis */
  JS_ROM_VALUE(338), /* min */
  JS_ROM_VALUE(622), /* mkdir */
  ...
  JS_ROM_VALUE(605), /* read */
  JS_ROM_VALUE(607), /* readChunk */
  JS_ROM_VALUE(636), /* reboot */
  JS_ROM_VALUE(329), /* reduce */
  JS_ROM_VALUE(331), /* reduceRight */
  JS_ROM_VALUE(574), /* refresh */
  JS_ROM_VALUE(620), /* remove */
  ...
  JS_ROM_VALUE(628), /* v1.0.0 */
  JS_ROM_VALUE(124), /* value */
  JS_ROM_VALUE(102), /* valueOf */
  JS_ROM_VALUE(12), /* var */
  JS_ROM_VALUE(626), /* version */
  JS_ROM_VALUE(18), /* void */
  JS_ROM_VALUE(594), /* waitKey */
  JS_ROM_VALUE(31), /* while */
  JS_ROM_VALUE(550), /* width */
  JS_ROM_VALUE(60), /* with */
  JS_ROM_VALUE(610), /* write */
  JS_ROM_VALUE(95), /* yield */

  /* properties (offset=932) */
  ...
  /* global object properties (offset=2274) */
...
static const JSCFunctionDef js_c_function_table[] = {
  ...
  { { .generic = js_performance_now },
    JS_ROM_VALUE(406) /* now */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_display_clear },
    JS_ROM_VALUE(554) /* clear */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_display_set_color },
    JS_ROM_VALUE(556) /* setColor */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_display_draw_text },
    JS_ROM_VALUE(559) /* drawText */,
    JS_CFUNC_generic, 4, 0 },
  { { .generic = js_display_draw_rect },
    JS_ROM_VALUE(562) /* drawRect */,
    JS_CFUNC_generic, 4, 0 },
  { { .generic = js_display_fill_rect },
    JS_ROM_VALUE(565) /* fillRect */,
    JS_CFUNC_generic, 4, 0 },
  { { .generic = js_display_draw_line },
    JS_ROM_VALUE(568) /* drawLine */,
    JS_CFUNC_generic, 4, 0 },
  { { .generic = js_display_draw_bitmap },
    JS_ROM_VALUE(571) /* drawBitmap */,
    JS_CFUNC_generic, 5, 0 },
  { { .generic = js_display_refresh },
    JS_ROM_VALUE(574) /* refresh */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_display_partial_refresh },
    JS_ROM_VALUE(576) /* partialRefresh */,
    JS_CFUNC_generic, 4, 0 },
  { { .generic = js_input_wait_key },
    JS_ROM_VALUE(594) /* waitKey */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_input_is_pressed },
    JS_ROM_VALUE(596) /* isPressed */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_fs_open },
    JS_ROM_VALUE(601) /* open */,
  ...
  { { .generic = js_fs_mkdir },
    JS_ROM_VALUE(622) /* mkdir */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_system_millis },
    JS_ROM_VALUE(630) /* millis */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_system_sleep },
    JS_ROM_VALUE(632) /* sleep */,
    JS_CFUNC_generic, 1, 0 },
  { { .generic = js_system_battery },
    JS_ROM_VALUE(634) /* battery */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_system_reboot },
    JS_ROM_VALUE(636) /* reboot */,
    JS_CFUNC_generic, 0, 0 },
  ...
  { { .generic = js_wifi_disconnect },
    JS_ROM_VALUE(642) /* disconnect */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_wifi_is_connected },
    JS_ROM_VALUE(645) /* isConnected */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_wifi_ip_address },
    JS_ROM_VALUE(648) /* ipAddress */,
    JS_CFUNC_generic, 0, 0 },
  { { .generic = js_http_get },
    JS_ROM_VALUE(126) /* get */,
    JS_CFUNC_generic, 2, 0 },
  { { .generic = js_http_post },
    JS_ROM_VALUE(653) /* post */,
    JS_CFUNC_generic, 3, 0 },
